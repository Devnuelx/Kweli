...
export default function HomeScreenWeb() {
    ...
    const handleBarCodeScanned = ({ data }: { data: string }) => {
        // Use the same logic as mobile: extract hash and call verifyQRCode
        handleQRScan(data);
    };
    ...
    const handleQRScan = async (data: string) => {
        ...
        try {
                ...
                if (alreadyScanned) {
                    ...
                    if (verificationResult.verified && actualReward > 0) {
                        ...
                        if (user?.hederaAccountId) {
                            try {
                                await associateToken(user.hederaAccountId);
                                await creditTokens(user.hederaAccountId, actualReward);
                            } catch (e) {
                                console.warn('Hedera sync error:', e);
                            }
                        }
            ...
            setLoading(false);
            setResult({ verified: false, message: 'Verification failed', verificationType: 'qr' });
            setShowResultSheet(true);
        }
    ...
    const handleAIVerification = async () => {
        ...
        try {
            ...
            if (response.success && response.data) {
                ...
                setLoading(false);
                setResult({ verified: false, message: response.error || 'Unable to verify product', verificationType: 'ai' });
                setShowResultSheet(true);
            }
        } catch (err) {
            console.error('AI verification error:', err);
            setLoading(false);
            setResult({ verified: false, message: 'AI verification failed', verificationType: 'ai' });
            setShowResultSheet(true);
        }
    };
        ...
        <View className="flex-1">
            ...
            >
                <View style={{
                    ...
                    shadowOpacity: 0.06, // much lighter on web
                    shadowRadius: 6,
                }} />
            </View>
            ...
            <View className="flex-1 justify-center items-center px-6 ">
                ...
                >
                    <Text className="text-gray-800 text-2xl font-bold tracking-tight text-center">
                        {showInitialText ? texts[0] : texts[currentTextIndex]}
                    </Text>
                    <Text className="text-gray-500 text-[10px] mt-2 tracking-widest uppercase text-center pb-4">
                ...
                <View className="relative">
                    <Animated.View
                        // Add borderRadius so the shadow is circular on web
                        style={{
                            transform: [
                            ...
                            shadowOpacity: 0.12, // reduced for web
                            shadowRadius: 12,
                            elevation: 8,
                            borderRadius: 224,
                        }}
                        ...
                        >
                            ...
                            >
                                <Image 
                                    ...
                                    style={{ width: '100%', height: '100%', tintColor: 'white', backgroundColor: 'transparent' }} 
                                    contentFit="contain"
                                />
                            </Animated.View>
                        </TouchableOpacity>
                        ...
                        <>
                            ...
                            <View className="absolute inset-0 justify-center items-center">
                                <View 
                                    ...
                                    style={{ borderColor: PRIMARY_BLUE, shadowOpacity: 0.04, shadowRadius: 6, elevation: 4 }}
                                >
                            ...
                            <View className="absolute top-0 left-0 right-0 pt-16 px-6">
                                <View className="bg-white/95 rounded-2xl p-4 border border-gray-200 shadow-lg" style={{ shadowOpacity: 0.06, shadowRadius: 8, elevation: 6 }}>
            ...
            <Modal visible={showAIScanner} animationType="fade" transparent>
                <View className="flex-1 bg-black/50 justify-center items-center px-6">
                    <View className="bg-white rounded-3xl p-8 border border-gray-200 w-full shadow-lg" style={{ shadowOpacity: 0.06, shadowRadius: 8, elevation: 6 }}>
            ...
            {loading && (
                <View className="absolute inset-0 bg-black/50 justify-center items-center z-50">
                    <View className="bg-white rounded-3xl p-12 items-center border border-gray-200 shadow-lg" style={{ shadowOpacity: 0.06, shadowRadius: 8, elevation: 6 }}>
